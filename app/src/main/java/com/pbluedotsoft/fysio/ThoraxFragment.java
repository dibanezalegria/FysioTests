 ...
 */
public class ThoraxFragment extends Fragment implements TextWatcher {

    private static final String LOG_TAG = ThoraxFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_thorax, container, false);
        ...
        LinearLayout layout = (LinearLayout) rootView.findViewById(R.id.thorax_layout_background);
        ...
        mEditText = (EditText) rootView.findViewById(R.id.thorax_edit_text);

        // Listeners
        mEditText.addTextChangedListener(this);

        // Done button
        Button btnDone = (Button) rootView.findViewById(R.id.thorax_btnDone);
